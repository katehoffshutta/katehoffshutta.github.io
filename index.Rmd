...
knitr::include_graphics("images/shutta_headshot.jpg")
```

## **About me**

I am a [Research Associate](https://connects.catalyst.harvard.edu/Profiles/display/Person/202432) at Harvard School of Public Health, exploring network models for multiomic data. Please feel free to email me (kshutta@hsph.harvard.edu) if you would like to learn about my research! I'd love to talk more and build collaborations. 
...
Network science meets the epigenome as we unravel COPD/IPF differential etiology in our new preprint: [Switch-like methylation of functional pathways distinguishes COPD and idiopathic pulmonary fibrosis](https://doi.org/10.64898/2025.12.18.25342312){target="_blank"}.
...
I'm thrilled to expand my research in network models of lung disease thanks to my recently funded K25 award from the National Heart, Lung, and Blood Institute of the NIH: [Multi-omic network methods for mapping molecular trajectories of age-related lung diseases](https://reporter.nih.gov/project-details/11136668){target="_blank"}. 

### 20 October 2025: tcga-data-nf and NetworkDataCompanion are published in GigaScience!

The Quackenbush lab has published a [Nextflow workflow for reproducible processing and analysis of gene regulatory networks](https://github.com/QuackenbushLab/tcga-data-nf) in TCGA. Check out the results in our [Gigascience paper](https://doi.org/10.1093/gigascience/giaf126){target="_blank"}, where we use DRAGON and PANDA networks to investigate consensus molecular subtypes of colon cancer, identifying key epigenetic features related to subtype-specific regulatory differences. 
...
SpiderLearner is our ensemble method for estimating Gaussian graphical models. 
